...
- Computer vision currently has concept coverage but limited technology dossiers in `Resources/Technologies`.
...
- For each concept, attach at least one `Resources/Processed_Transcripts/...#^block-id` source.
