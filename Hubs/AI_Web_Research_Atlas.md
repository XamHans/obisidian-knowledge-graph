...
## Overview
- Web-researched atlas for widening concept discovery across AI Agents, tool calling, structured outputs, evals, context engineering, RAG, and chunking.
...
- OpenAI Long-run agent tips (skills/shell/compaction): https://developers.openai.com/blog/skills-shell-tips
